...
COVID19_US_cases_new = COVID19_US_cases.drop(['UID','iso2','iso3','code3','FIPS','Admin2','Country_Region','Province_State','Lat','Long_'], axis=1)
...
COVID19_US_cases_sum = COVID19_US_cases_new.groupby(['Combined_Key']).sum()
...
COVID19_US_cases_melt = COVID19_US_cases_transpose.melt(id_vars= 'index', var_name='Combined_Key', value_name='cases')
...
COVID19_US_cases_melt.to_csv(r'c:\Users\thead\Documents\bootcamp\COVID19_out\COVID19_US_cases_county_melt.csv', index = False)
...
COVID19_US_deaths_new = COVID19_US_deaths.drop(['Population','UID','iso2','iso3','code3','FIPS','Admin2','Country_Region','Lat','Long_'], axis=1)
...
COVID19_US_deaths_sum = COVID19_US_deaths_new.groupby(['Combined_Key']).sum()
...
COVID19_US_deaths_melt = COVID19_US_deaths_transpose.melt(id_vars= 'index', var_name='Combined_Key', value_name='deaths')
...
COVID19_US_deaths_melt.to_csv(r'c:\Users\thead\Documents\bootcamp\COVID19_out\COVID19_US_deaths_county_melt.csv', index = False)
